...
gcloud iam service-accounts create "$HALYARD_SERVICE_ACCOUNT" --project="$GCP_PROJECT" --display-name "$HALYARD_SERVICE_ACCOUNT"
...
gcloud iam service-accounts create "$GCS_SERVICE_ACCOUNT" --project="$GCP_PROJECT" --display-name "$GCS_SERVICE_ACCOUNT"
