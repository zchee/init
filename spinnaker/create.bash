...
gcloud alpha container --project "$GCP_PROJECT" clusters create "$SPINNAKER_CLUSTER" --zone="$SPINNAKER_ZONE" --machine-type="$SPINNAKER_MACHINE_TYPE" --num-nodes="$SPINNAKER_NUM_NODES" --local-ssd-count "1" --enable-cloud-logging --no-enable-cloud-monitoring --enable-legacy-authorization --scopes=default,compute-rw,https://www.googleapis.com/auth/devstorage.read_only,logging-write,monitoring,service-control,service-management,https://www.googleapis.com/auth/trace.append,userinfo-email
